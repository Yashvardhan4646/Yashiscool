...
export default function Home() {
  ...
  const [terminalLines, setTerminalLines] = useState([
    { text: "Yashvardhan OS v1.0.0 Boot Sequence successful.", type: "stdout" },
    { text: "Type 'help' or click macros below to interact.", type: "stdout" }
  ]);

  // Execute terminal macro scripts
      ...
      <div className="page-fade-in home-page">
        ...
        <section className="os-window-hero">
          ...
          <div className="os-window-body">
            ...
            {/* Monospace Interactive Shell terminal inside Hero window */}
            <div className="terminal-shell-window">
              <div className="terminal-shell-output">
