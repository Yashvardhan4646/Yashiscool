...
import { ArrowRight, Award, Compass, Layers, Star, User, Folder, Mail, Terminal, FileCode, Gamepad2 } from "lucide-react";
      ...
      <div className="page-fade-in home-page">
        ...
        <div className="desktop-grid">
          ...
          <div className="desktop-shortcut" onClick={() => setActiveModal("snake")}>
            <div className="shortcut-icon-box" style={{ backgroundColor: "var(--pastel-mint)", color: "var(--accent-green)" }}>
              <Gamepad2 size={20} strokeWidth={2.5} />
            </div>
            <span className="shortcut-label">snake.exe</span>
          </div>
        </div>
